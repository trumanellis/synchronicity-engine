...
import { 
  ...
  bidOnOffering,
  acceptOfferingBids,
  calculateTokenTreeDuration
} from '../src/lib/synchronicity-engine'
import type { OfferingDoc, BlessingDoc } from '../src/lib/types'
...
describe('Create Offering', () => {
  ...
  it('should create an offering with limited slots', async () => {
    ...
    const offeringDoc: OfferingDoc = offering.value
...
async function rankOfferingBids(offering: OfferingDoc, databases: any) {
  const rankedBids = []
